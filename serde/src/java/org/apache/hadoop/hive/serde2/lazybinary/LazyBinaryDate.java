...
/**
 * LazyBinaryDate
 * A LazyBinaryObject that encodes a java.sql.Date in a VLong.
 *
 */
public class LazyBinaryDate extends
  ...
  public void init(ByteArrayRef bytes, int start, int length) {
    VLong l = new VLong();
    LazyBinaryUtils.readVLong(bytes.getData(), start, l);
    data.set(DateWritable.timeToDate(l.value));
  }

  public static void write(Output byteStream, DateWritable d) {
    LazyBinaryUtils.writeVLong(byteStream, d.getTimeInSeconds());
  }
}
